...
def fun_method05(request):
	return render(request, 'app005/index.html')

def fun_display01(request):

	info = pd.read_excel('./网易云.xls', sheet_name='网易云')
	...
	singer01 = singer_real[0:79]
	link01 = link_real[0:79]
	intro01 = intro_real[0:79]
	...
	return render(request,'app001/html01.html',{'total':total})
...
def fun_display02(request):
	...
	singer02 = singer_real[80:159]
	link02 = link_real[80:159]
	intro02 = intro_real[80:159]
	...
	return render(request,'app001/html02.html',{'total':total})
...
def fun_display03(request):
	...
	singer03 = singer_real[160:239]
	link03 = link_real[160:239]
	intro03 = intro_real[160:239]
	...
	for i in range(len(singer03)):
		...
		total.append(sig)
	return render(request,'app001/html03.html',{'total':total})
...
def fun_display04(request):
	...
	singer04 = singer_real[240:319]
	link04 = link_real[240:319]
	intro04 = intro_real[240:319]
	...
	return render(request,'app001/html04.html',{'total':total})
...
def fun_display05(request):
	...
	return render(request,'app001/html05.html',{'total':total})
